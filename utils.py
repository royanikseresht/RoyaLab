...
def write_footer(footer_text: str = "Crafted with ❤️ by Roya Nikseresht", 
                bg_color: str = "#6d8ca3", 
    ...
    Args:
        footer_text (str, optional): The text to display as the footer. Default is "Crafted with ❤️ by Roya Nikseresht".
        bg_color (str, optional): The background color of the footer in hexadecimal format. Default is "#6d8ca3".
